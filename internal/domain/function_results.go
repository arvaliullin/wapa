...
type Metrics struct {
	Mean         float64 `json:"mean" example:"0.03908375787580277"`
	...
	Variance     float64 `json:"variance,omitempty" example:"0.0009084751759906766"`
	StdDeviation float64 `json:"std_deviation,omitempty" example:"0.030140921949911827"`
}
